🍽️ CeylonMealApp
📖 Overview
CeylonMealApp is a full-stack web application that helps users discover and manage meal recipes. It combines recipes from TheMealDB API with a local SQLite database, allowing users to explore new meals while keeping their own personal collection in one place.
